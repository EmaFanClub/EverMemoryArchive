...
describe('Note Tools', () => {
  ...
  describe('RecallNoteTool', () => {
    beforeEach(async () => {
      ...
      await sessionNoteTool.execute('Discussed project timeline and milestones', 'meeting');
      await sessionNoteTool.execute('Reviewed PR #123: Fixed authentication bug', 'code_review');
