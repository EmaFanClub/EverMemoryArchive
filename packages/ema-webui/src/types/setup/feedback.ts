...
export const fieldLabels: Record<string, string> = {
  ...
  "llm.envKey": "LLM ApiKey",
  "llm.projectEnvKey": "LLM Vertex AI 项目",
  "llm.locationEnvKey": "LLM Vertex AI 区域",
  "llm.credentialsEnvKey": "LLM Vertex AI 凭据",
  ...
  "embedding.projectEnvKey": "Embedding Vertex AI 项目",
  "embedding.locationEnvKey": "Embedding Vertex AI 区域",
  "embedding.credentialsEnvKey": "Embedding Vertex AI 凭据",
  "owner.name": "名称",
  "owner.qq": "QQ 号",
};
